        ...
        <div className="grid mb-8 lg:grid-cols-6">
          ...
          <div className="md:max-w-md lg:col-span-2 lg:mt-0 mt-5">
            ...
            <p className="mt-4 text-sm text-gray-500">
              ...
              veritatis error nemo eveniet eum ab voluptate aliquid nesciunt
              commodi quae sequi reprehenderit porro, quasi excepturi dolor
              molestiae aspernatur dolore esse quam. Et, quis.
            </p>
          </div>
        </div>
